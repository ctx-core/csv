...
/** @typedef {import('./index.d.ts').csv__row__parse_o_T}.csv__row__parse_o_T */
/** @typedef {import('./index.d.ts').csv__row__row__T}.csv__row__row__T */
/**
 * @param {string}csv
 ...
 * @private
 */
export function csv__row_(csv, csv__parse_o) {
	const { row_ } = csv__parse_o.data
	for (const csv__datum_a of csv__parse(csv, csv__parse_o)) {
