...
export declare function b__path__csv<I extends unknown = unknown>(ctx?: object): Writable<string | null> & {
    load__data__csv(opts?: Opts__load__data__csv<I> | undefined): Promise<maybe<$table_type<number>, import("@ctx-core/function").falsy>>;
} & {
    load__data__csv: (opts?: Opts__load__data__csv<number>) => Promise<maybe<$table_type<number>, import("@ctx-core/function").falsy>>;
};
